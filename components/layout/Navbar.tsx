          ...
          <div className="flex items-center gap-3 shrink-0 pointer-events-auto">
            ...
            <div className="relative">
              <button
                ...
                className="group w-9 h-9 rounded-full glass flex items-center justify-center text-xs font-semibold text-[var(--muted)] hover:text-[var(--foreground)] transition-colors"
              >
                {initials}
              </button>
              {menuOpen && (
