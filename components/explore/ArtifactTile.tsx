  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full">
        ...
        {/* Hover UI */}
        <div className="absolute inset-0 flex flex-col justify-end p-3 gap-2 opacity-0 group-hover:opacity-100 transition-all duration-200 translate-y-1 group-hover:translate-y-0">
          {/* Reaction buttons */}
            ...
            {EMOJIS.map((emoji) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-semibold transition-all duration-150 backdrop-blur-sm",
                    active
          ...
          {/* User pill */}
          <div className="flex items-center gap-2 bg-black/50 backdrop-blur-sm rounded-full px-2 py-1.5 min-w-0 self-start max-w-full">
            {artifact.user.image ? (
              // eslint-disable-next-line @next/next/no-img-element
              <img
